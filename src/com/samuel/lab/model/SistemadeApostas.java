...
public interface SistemadeApostas {
	 ...
	 * @param centavos : centavos inicial no caixa do sistema
	 * @param taxa : Taxa que será cobrada aos apostadores
	 */
	 ...
	 * @param id : Um Inteiro que representa o id do cenário que será exibido 
	 ...
	 * @param cenario : Um inteiro representando em qual cenário será feita a aposta 
	 * @param apostador : Uma String representando o nome do apostador
	 * @param valor : Um inteiro representando o valor em centavos da aposta
	 * @param previsao : Um valor bolleano que representa a previsao do apostador
	 */
	public void cadastrarAposta(int cenario, String apostador, int valor, boolean previsao);
	
	/**
	 * Método responsável por calcular o valor total arrecardado com as apostas de um cenário
	 * @param cenario : Um inteiro representando o id do cenário que será verificado 
	 ...
	 * @param cenario : Um inteiro representando o id do cenário será feita a aposta
	 ...
	 * @param cenario : Um inteiro representando o id do cenário será fechado
	 * @param ocorreu : Um valor boleano que indica e o cenário ocorreu ou não
	 */
	public void fecharAposta(int cenario, boolean ocorreu);
	
	/**
	 * Método responsável por retornar o valor total de um cenário encerrado que será destinado ao caixa
	 * @param cenario: Um inteiro representando o id do cenário será recuperado o caixa
	 * @return : Um inteiro representando o caixa do cenário
	 */
	public int getCaixaCenario(int cenario);
	
	/**
	 * Método responsável por retornar o valor total de um cenário encerrado que será destinado a distribuição entre as apostas vencedoras
	 * @param cenario : Um inteiro representando o id do cenário que será verificado
